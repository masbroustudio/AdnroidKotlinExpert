...
//        try {
//            jsonString = context.resources.openRawResource(R.raw.kokasdummydata).bufferedReader()
//                .use { it.readText() }
...
//        val listArray = responseObject.getJSONArray("kokasdummydata")
...
//            val ingradient = course.get("ingredients")
//
